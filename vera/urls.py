...
urlpatterns = [
    ...
    path('events/complete/', views.event_complete, name='events_complete'),
    path('events/<str:date>/', views.EventsByDateView.as_view(), name='events_by_date'),
    path('article/<int:pk>/', views.ArticleView.as_view(), name='article'),
    path('articles/', views.ArticlesView.as_view(), name='articles'),
    path('articles/like/', views.articles_like, name='articles_like'),
